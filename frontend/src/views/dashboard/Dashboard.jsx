...
function Dashboard() {
    ...
    const userId = useUserData()?.user_id; // extraire le user_id depuis le token_decoder
    ...
    const fetchDashboardData = async () => {
        ...
        const noti_res = await apiInstance.get(`author/dashboard/Notif-list/${userId}/`);
    ...
    const handleMarkNotiAsSeen = async (notiId) => {
        const response = await apiInstance.post("author/dashboard/noti-mark/", { noti_id: notiId });
                                            ...
                                            <>
                                                <div className="col-12">
                                                    <div className="d-flex position-relative">
                                                        <img className="w-60 rounded" src={p.imagePost} style={{ width: "100px", height: "110px", objectFit: "cover", borderRadius: "10px" }} alt="product" />
                                                        <div className="ms-3">
