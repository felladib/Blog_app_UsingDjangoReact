...
function Detail() {
    ...
    // est un hook de React qui vous permet d'ajouter un état local à vos composants fonctionnels.
    ...
    /*
    befor :
    const [createComment, setCreateComment] = useState({ full_name: "John Doe", email: "john@example.com", comment: "Hello World" });

    setCreateComment({
    ...createComment, (...create a copie) // { full_name: "John Doe", email: "john@example.com", comment: "Hello World" }
    [event.target.name]: event.target.value, // { email: "jane@example.com" }
    });
    after :
    { full_name: "John Doe", email: "jane@example.com", comment: "Hello World" }

    */

    const handleCreateCommentSubmit = async (e) => {
        e.preventDefault(); // pour ne pas relaod la page lorsque la requet est envoyée
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <div className="text-start text-lg-center mb-5" data-sticky="" data-margin-top={80} data-sticky-for={991}>
                                ...
                                <button onClick={handeLikePost} className="btn btn-primary">
                                    <i className="fas fa-thumbs-up" style={{"marginRight":"3px"}}></i>
                                    {post?.likes?.length}
                                </button>

                                <button onClick={handeBookMarkPost} className="btn btn-danger ms-2">
